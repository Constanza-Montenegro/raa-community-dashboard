...
const platforms = {
  data: [
    { name: "LandStat Portal", logo: "\ud83d\udcca", description: "National performance tracking system for monitoring land condition and reporting on restoration targets.", relevance: "Official tracking system enabling country parties to report progress on land degradation neutrality goals.", objectives: ["National reporting on land degradation", "Tracking restoration framework indicators", "Data harmonisation across countries"], link: "" },
    { name: "TerraPulse", logo: "\ud83c\udf0d", description: "Open-source satellite monitoring tool for detecting land change using cloud-based earth observation data.", relevance: "Enables countries and organisations to monitor land condition using satellite data without requiring advanced technical capacity.", objectives: ["Monitor land productivity dynamics", "Track land cover change", "Assess carbon stock changes"], link: "" },
    { name: "EarthState Assessment", logo: "\ud83d\uddfa\ufe0f", description: "Flagship global report providing data and analysis on the condition of the world's land resources.", relevance: "Provides the most comprehensive global assessment of land degradation trends and restoration opportunities.", objectives: ["Assess global land degradation status", "Model future land use scenarios", "Inform policy and investment decisions"], link: "" },
    { name: "SoilSmart Knowledge Base", logo: "\ud83d\udcc0", description: "Curated global database of field-validated sustainable land management technologies and practices.", relevance: "Largest global database of field-tested sustainable land management technologies and approaches.", objectives: ["Document SLM best practices", "Facilitate knowledge sharing", "Support evidence-based decision making"], link: "" }
  ],
  funding: [
    { name: "EcoFinance Fund", logo: "\ud83c\udf10", description: "International funding mechanism supporting projects addressing biodiversity, land degradation and climate change.", relevance: "Primary multilateral funding source for land degradation neutrality projects worldwide.", objectives: ["Fund land degradation neutrality projects", "Support enabling activities for restoration", "Catalyse co-financing for restoration"], link: "" },
    { name: "ClimateRestore Initiative", logo: "\ud83c\udf31", description: "Global fund channelling investment into climate adaptation and land restoration in developing countries.", relevance: "Key funding source for climate-related land restoration and drought resilience projects in developing countries.", objectives: ["Finance climate adaptation projects", "Support low-emission development", "Strengthen institutional capacity"], link: "" },
    { name: "LandBalance Impact Fund", logo: "\ud83c\udfe6", description: "Impact investment vehicle dedicated to projects delivering measurable land degradation neutrality outcomes.", relevance: "First-of-its-kind impact investment fund dedicated exclusively to land degradation neutrality.", objectives: ["Mobilise private capital for land restoration", "Fund sustainable land management projects", "Bridge public and private finance"], link: "" }
  ],
  knowledge: [
    { name: "LandKnow Exchange", logo: "\ud83d\udcda", description: "Central platform for knowledge sharing on desertification, land degradation and drought management.", relevance: "Open knowledge platform connecting practitioners, researchers and policymakers working on land issues.", objectives: ["Centralise knowledge on DLDD", "Connect communities of practice", "Support capacity building"], link: "" },
    { name: "Global Resources Institute", logo: "\ud83c\udf3f", description: "International research organisation developing data-driven solutions for land, water and food systems.", relevance: "Leading research institution providing data-driven solutions for sustainable land and forest management.", objectives: ["Produce actionable research", "Develop monitoring tools", "Inform global policy frameworks"], link: "" },
    { name: "AgroScience Partnership", logo: "\ud83c\udf3e", description: "Global agricultural research network advancing innovation in sustainable land management and food security.", relevance: "World's largest agricultural research network with direct relevance to land restoration and food systems.", objectives: ["Advance agricultural innovation", "Improve land and water management", "Strengthen food system resilience"], link: "" },
    { name: "LandscapeConnect Forum", logo: "\ud83c\udf33", description: "Multi-stakeholder convening platform for integrated landscape management and restoration science.", relevance: "Largest knowledge-led platform on sustainable landscapes, bridging science, policy and practice.", objectives: ["Convene cross-sector dialogue", "Promote landscape approaches", "Scale up restoration knowledge"], link: "" }
  ]
};
