...
const platforms = {
  data: [
    { name: "LandStat Portal", logo: "\ud83d\udcca", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore.", relevance: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", objectives: ["Lorem ipsum dolor sit amet", "Consectetur adipiscing elit", "Sed do eiusmod tempor"], link: "" },
    { name: "TerraPulse", logo: "\ud83c\udf0d", description: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.", relevance: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", objectives: ["Ut enim ad minim veniam", "Quis nostrud exercitation", "Ullamco laboris nisi"], link: "" },
    { name: "EarthState Assessment", logo: "\ud83d\uddfa\ufe0f", description: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.", relevance: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur.", objectives: ["Duis aute irure dolor", "Reprehenderit in voluptate", "Cillum dolore eu fugiat"], link: "" },
  ...
  funding: [
    ...
    { name: "LandBalance Impact Fund", logo: "\ud83c\udfe6", description: "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est.", relevance: "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", objectives: ["Excepteur sint occaecat", "Cupidatat non proident", "Officia deserunt mollit"], link: "" }
  ],
  knowledge: [
    { name: "LandKnow Exchange", logo: "\ud83d\udcda", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore.", relevance: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.", objectives: ["Lorem ipsum dolor sit amet", "Consectetur adipiscing elit", "Sed do eiusmod tempor"], link: "" },
    { name: "Global Resources Institute", logo: "\ud83c\udf3f", description: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.", relevance: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", objectives: ["Ut enim ad minim veniam", "Quis nostrud exercitation", "Ullamco laboris nisi"], link: "" },
    { name: "AgroScience Partnership", logo: "\ud83c\udf3e", description: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.", relevance: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur.", objectives: ["Duis aute irure dolor", "Reprehenderit in voluptate", "Cillum dolore eu fugiat"], link: "" },
    { name: "LandscapeConnect Forum", logo: "\ud83c\udf33", description: "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est.", relevance: "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", objectives: ["Excepteur sint occaecat", "Cupidatat non proident", "Officia deserunt mollit"], link: "" }
  ]
};
