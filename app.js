// ============================================================
// RAA COMMUNITY PLATFORM — APP LOGIC
// ============================================================
...
function showProfile(name, showDirectoryBtn) {
  ...
  // Header with logo
  const secondLogoLabel = init.logo2Label ? `<span class="pro-header-partnership-label">${init.logo2Label}</span>` : '';
  const secondLogoHtml = init.logo2 ? `<div class="pro-header-secondary-logo">${secondLogoLabel}<img src="${init.logo2}" alt="" style="height:48px;max-width:140px;object-fit:contain;" onerror="this.parentElement.style.display='none'"></div>` : '';
